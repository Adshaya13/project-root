...
const isRTL = (text) =>
  typeof text === 'string' && /[\u0590-\u05FF\u0600-\u06FF\u0700-\u074F]/.test(text);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg viewBox="0 0 24 24" fill="var(--card-text-main)" width="24" height="24">
      ...
      <div className="bauhaus-card-body">
        <h3 style={{ direction: isRTL(mainText) ? 'rtl' : 'ltr' }} title={mainText}>{mainText}</h3>
