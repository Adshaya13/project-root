...
- **"Port 5173 is already in use"**: If you see this error when running `npm start`, it means another process is using the port. Stop the other process or change `PORT` in `.env` if you intentionally want a different local port.
